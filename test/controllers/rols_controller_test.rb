...
class RolsControllerTest < ActionController::TestCase
  ...
  test "should create rol" do
    assert_difference('Rol.count') do
      post :create, rol: { rolestado: @rol.rolestado, rolfechacreacion: @rol.rolfechacreacion, rolnombre: @rol.rolnombre }
    end
  ...
  test "should update rol" do
    patch :update, id: @rol, rol: { rolestado: @rol.rolestado, rolfechacreacion: @rol.rolfechacreacion, rolnombre: @rol.rolnombre }
    assert_redirected_to rol_path(assigns(:rol))
  end
